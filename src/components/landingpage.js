...
class LandingPage extends React.Component {
    ...
    renderTabOverview() {
        return (
            <div>
                    ...
                    <Cell component={Card} col={12}>
                        <Grid component={CardText} noSpacing>
                            ...
                            <Cell className="section__circle-container" col={2} phone={1}>
                                <div className={classNames('section__circle-container__circle')}></div>
                            </Cell>
                ...
                <Grid component="section" className={classNames('section--footer')}>
                    <Cell className="section__circle-container" col={2} phone={1}>
                        <div className={classNames('section__circle-container__circle section__circle--big')}></div>
                    </Cell>
    ...
    render() {
        ...
        return (
                    ...
                    <Layout fixedHeader className={classNames("header-color")}>
                        <Header className={classNames("header-color")} title="Material Design Lite" scroll>
                            <HeaderRow className="mdl-layout--large-screen-only" />
                            <HeaderRow className="mdl-layout--large-screen-only">
                                <h3>Name &amp; Title</h3>
                            </HeaderRow>
                            <HeaderRow className="mdl-layout--large-screen-only" />
                            <HeaderTabs activeTab={this.state.activeHeaderTab} onChange={this.onChangeHeaderTab} ripple>
                                <Tab>Overview</Tab>
                                <Tab>Features</Tab>
                                <Tab>Details</Tab>
                                <Tab>Technology</Tab>
